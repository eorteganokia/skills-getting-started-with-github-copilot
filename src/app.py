...
activities = {
    ...
    "Art Club": {
        "description": "Painting, drawing, and mixed-media workshops for all levels",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["emma.b@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, STEM projects, and science fairs",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["ava.t@mergington.edu", "mason@mergington.edu"]
    }
}
